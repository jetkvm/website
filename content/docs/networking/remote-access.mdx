...
Tailscale is not pre-installed on the device. However, Tailscale has added out-of-the-box support for JetKVM, which means you can easily install Tailscale on your device remotely from your computer.

1. [Add your SSH key to JetKVM](https://jetkvm.com/docs/advanced-usage/developing#developer-mode)
