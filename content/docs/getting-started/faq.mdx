...
Brandon, a member of the JetKVM community, has created a helpful [Tailscale installer guide](https://medium.com/@brandontuttle/installing-tailscale-on-a-jetkvm-3c72355b7eb0). Take a look and get started!
